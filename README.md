...
Inserção e remoção de itens no início, fim ou posição específica da lista
Simulação da rotina de autocuidado por período do dia (manhã, tarde e noite)
Avaliação do tipo de pele com validação de campos
